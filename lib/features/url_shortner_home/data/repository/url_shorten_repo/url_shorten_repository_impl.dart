...
import 'package:url_shortner/features/url_shortner_home/domain/repository/url_shorten_repository.dart';
...
class UrlShortenRepositoryImpl implements UrlShortenRepository {
  ...
  @override
  Future<Either<Failure, UrlShortnerEntity>> getShortenUrl() async{
    try {
      final UrlShortnerModel result = await urlShortenData.getShortenUrl();
      return right(result);
